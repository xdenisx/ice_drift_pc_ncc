...
#
#       python ./download-all-2020-01-21_11-00-51.py
#
#    Download all files in a Metalink/CSV: (downloaded from ASF Vertex)
#
#       python ./download-all-2020-01-21_11-00-51.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
#
...
try:
    out_dir = sys.argv[2] #'/mnt/sverdrup-2/sat_auxdata/denoise/fram_kara/s1/ew/zip/'
except Exception as ex:
    print('\n%s\n\nPLEASE SPECIFY OUTPUT DIRECTORY PATH! EXIT\n' % ex)
    sys.exit(1)
...
class bulk_downloader:
    ...
    def download_file_with_cookiejar(self, url, file_count, total, recursion=False):
       ...
       download_file = '%s/%s' % (out_dir, os.path.basename(url).split('?')[0])
       ...
       try:
          ...
          tf = tempfile.NamedTemporaryFile(mode='w+b', delete=False, dir='%s' % out_dir)
